...
class Anthena:
    ...
    def __init__(self, Type='', args=('',''),verbose=True):
            ...
            while True:
                ...
                try:
                    ...
                    if self._verbose:
                        print res
                        if len(str(res)) > 1000:
                            with open('/home/yt/workingLib/django/mysite/NetworkMonitor/log', mode='w') as save:
                               save.write(str(res))
                               save.close()
    ...
    def write(self):
        with open("/home/yt/workingLib/django/mysite/NetworkMonitor/lgs.txt", mode='a') as log:
