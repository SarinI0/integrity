...
html += str(name)
html +=  ' &nbsp;&nbsp;</p><pstyle="color:white">&nbsp;&nbsp;tnx for creating an account at Sarin.io&nbsp;&nbsp;</p><p style="color:white">&nbsp;&nbsp;we hope you will find our services usefull.&nbsp;</p><p style="color:white">&nbsp;&nbsp;For further information, please dont hesitate to contact&nbsp;</p><p  style="color:white">&nbsp;&nbsp;relay@sarin.io&nbsp;</p><p  style="color:white">&nbsp;&nbsp;for activating your account you only need to verify your&nbsp;</p><p  style="color:white">&nbsp;&nbsp;phone number.&nbsp;</p><p>&nbsp;&nbsp;an sms was sent to your phone with a 5 digit code&nbsp;</p><p>&nbsp;&nbsp;please refer to the link below to</p><a href="https://sarin.io:'
html += str(sys.argv[-1])
html += "/"
html += str(sys.argv[-2])
html += "/"
html += 'activate" style="color: white;">&nbsp;&nbsp;Activate your account.</a><p>&nbsp;&nbsp;best regards Sarin.io&nbsp;&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p style="position: absolute; left:22%; top:125%;">Sarin.io</p><p>&nbsp; <p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p></div></body></html>'
...
username = 'relay@sarin.io'
password = 'Ki79..,;8.7.Ai9'
